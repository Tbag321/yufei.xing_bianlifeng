...
and store_code = '100078005'
and t.sku_class_code not in ('86','50')
and order_date between '2019-07-01' and '2019-12-31'
group by
t.store_code
,store_city) x
) a
...
and store_code = '100078005'
and t.sku_class_code not in ('86','50')
and order_date between '2020-07-01' and '2020-12-31'
group by
t.store_code
,store_city) x
) a
...
and store_code = '100078005'
and t.sku_class_code not in ('86','50')
and order_date between '2021-07-01' and '2021-12-31'
group by
t.store_code
,store_city) x
) a
...
and store_code = '100078005'
and t.sku_class_code not in ('86','50')
and order_date between '2022-07-01' and '2022-12-31'
group by
t.store_code
,store_city) x
) a
...
and store_code = '100078005'
and t.sku_class_code not in ('86','50')
and order_date between '2023-07-01' and '2023-12-31'
group by
t.store_code
,store_city) x
) a
...
,a.location_type
,'全周' as is_working_day
,e.val_order_day --日均单量
,e.al_order_day --9月日均单量
from date_store_list a
...
left join nine_sale_null d on a.store_code = d.store_code
left join data_build.dwd_app_order_by_category_workday_or_notworkday_v1_da e on a.record_week = e.record_week and a.store_code = e.store_code and a.bool = e.bool_order and e.dt = date_format(date_sub(current_date(),1),'yyyyMMdd')
and e.is_working_day = '全周'
where d.store_code is null
),
...
left join nine_sale_null d on a.store_code = d.store_code
left join data_build.dwd_app_order_by_category_workday_or_notworkday_v1_da e on a.record_week = e.record_week and a.store_code = e.store_code and a.bool = e.bool_order and e.dt = date_format(date_sub(current_date(),1),'yyyyMMdd')
and a.is_working_day = e.is_working_day and e.is_working_day in ('1','0')
where d.store_code is null
)
