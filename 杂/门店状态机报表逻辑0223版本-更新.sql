...
(
	...
	left join dim_store_construction_project_info t2 on t1.flag_code = t2.flag_code and t2.dt = date_format(date_sub(current_date(),1),'yyyyMMdd')
	...
	--and t1.is_delete = 0 
	and t1.dt = date_format(date_sub(current_date(),1),'yyyyMMdd') and t1.hr = '21'
	...
	(
		...
		*
		from data_build.pdw_opc_engineering_engineering_report_all
	 	where dt = date_format(date_sub(current_date(),2),'yyyyMMdd') --刷新时间比较晚
