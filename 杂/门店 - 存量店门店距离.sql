...
(
	...
	left join dim_store_construction_project_info t2 on t1.flag_code = t2.flag_code and t2.dt = 20231221
	...
	--and t1.is_delete = 0 
	and t1.dt = 20231221 and t1.hr = '21'
...
(
	...
	from data_build.dm_ordering_information_system_order_detail_view --data_smartorder.dm_ordering_information_system_order_detail
...
left join store_status_engineering_store j on a.store_code = j.shop_code),

a_store_list as(
select
t.*
,b.*
from data_smartorder.dm_order_external_same_city_store_riding_distance_type_zero_do_business_union_all t
left join store_list b on t.a_store_code = b.store_code
where t.dt = 20231221
)
...
,b.store_status_blf
from a_store_list t
left join store_list b on t.b_store_code = b.store_code
where t.store_status_blf in ('1正常保留-已开业门店','2正常保留-未开业门店')
and b.store_status_blf in ('1正常保留-已开业门店','2正常保留-未开业门店')